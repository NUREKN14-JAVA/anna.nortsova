package com.annanortsova.usermanagement.gui;
...
import com.annanortsova.usermanagement.db.DaoFactory;
import com.annanortsova.usermanagement.db.MockDaoFactory;
import com.annanortsova.usermanagement.util.Messages;
...
public class MainFrameTest extends JFCTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        try {
            ...
            User testUser = new User(666L, "Maks", "Berger", LocalDate.now());
    ...
    public void testDetailsPanel() {
    	...
    	try {
			...
			table = (JTable) find(JTable.class, "userTable");
			find(JPanel.class, "browsePanel");
			if (!"Maks".equals(firstName.getText())){
				fail("Wrong user");
			}
			if (!"Berger".equals(lastName.getText())) {
				fail("Wrong user");
			}
			mockUserDao.verify();
		} catch (Exception e) {
    ...
    public void testDeleteUser() {
    	try {
			 User expectedUser = new User(new Long(666), "Maks", "Berger",  LocalDate.now());
